...
export const spreads: TarotSpread[] = [
  {
    ...
    featured: true,
    positions: [
      { index: 0, name: "指引", meaning: "此刻宇宙想让你听见的讯息", x: 50, y: 50 },
    ],
  },
  {
    ...
    featured: true,
    positions: [
      { index: 0, name: "过去", meaning: "事情的根源与过往的影响", x: 20, y: 50 },
      { index: 1, name: "现在", meaning: "当下的能量与真实处境", x: 50, y: 50 },
      { index: 2, name: "未来", meaning: "维持现状时最可能的走向", x: 80, y: 50 },
    ],
  },
  {
  ...
  },
  {
    ...
    featured: true,
    positions: [
      { index: 0, name: "你的状态", meaning: "你在这段关系中的心境与姿态", x: 22, y: 32 },
      { index: 1, name: "对方状态", meaning: "对方此刻的心境与态度", x: 78, y: 32 },
      { index: 2, name: "关系联结", meaning: "你们之间真实的联结质量", x: 50, y: 55 },
      { index: 3, name: "发展方向", meaning: "这段关系最可能的走向", x: 50, y: 84 },
    ],
  },
  {
    id: "career-choice",
    ...
    featured: true,
    positions: [
      { index: 0, name: "当前处境", meaning: "你在事业中的真实位置", x: 50, y: 82 },
      { index: 1, name: "道路 A", meaning: "第一个选择的能量与前景", x: 24, y: 44 },
      { index: 2, name: "道路 B", meaning: "第二个选择的能量与前景", x: 76, y: 44 },
      { index: 3, name: "潜在因素", meaning: "你尚未看见的关键变量", x: 50, y: 55 },
  ...
  },
  {
    ...
    description:
      "火、水、风、土四元素加精神中心,全面扫描你当下的能量状态。",
    cardCount: 5,
    scenarios: ["能量检视", "自我探索", "身心平衡"],
    difficulty: "进阶",
    estimatedMinutes: 12,
    positions: [
      { index: 0, name: "火 · 行动", meaning: "你的动力、热情与行动力", x: 50, y: 14 },
      { index: 1, name: "水 · 情感", meaning: "你的情绪与感受之流", x: 82, y: 42 },
      { index: 2, name: "风 · 思绪", meaning: "你的思考方式与沟通", x: 68, y: 84 },
      { index: 3, name: "土 · 现实", meaning: "你的物质基础与身体状态", x: 32, y: 84 },
      { index: 4, name: "灵 · 中心", meaning: "整合一切的核心课题", x: 18, y: 42 },
    ],
  },
  {
    id: "celtic-cross",
    ...
    positions: [
      ...
      { index: 1, name: "阻碍", meaning: "横亘在眼前的挑战", x: 34, y: 44, rotate: 90 },
      ...
      { index: 8, name: "希望与恐惧", meaning: "内心深处的期待与担忧", x: 82, y: 34 },
