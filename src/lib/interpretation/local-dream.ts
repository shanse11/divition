...
/** 常见梦境意象的温和释义库 */
const IMAGE_LIBRARY: Array<{ pattern: RegExp; image: string; meaning: string }> = [
  { pattern: /飞|翱翔|漂浮/, image: "飞翔", meaning: "或许对应着对自由的渴望,或想要摆脱某种现实束缚的心情" },
  { pattern: /坠落|掉下|跌/, image: "坠落", meaning: "可能映射着失控感,或对某件事情缺乏安全感" },
  { pattern: /追|逃|跑/, image: "追逐", meaning: "常与压力有关——现实中或许有你一直回避、却始终跟随的事" },
  { pattern: /水|海|河|雨|湖/, image: "水", meaning: "水常与情绪相连;它的平静或汹涌,可能正是你情绪的样子" },
  { pattern: /牙|牙齿/, image: "牙齿", meaning: "有人将其与失去、形象焦虑或表达受阻联系在一起" },
  { pattern: /考试|迟到|来不及/, image: "考试与迟到", meaning: "多与自我要求和担心辜负期待有关" },
  { pattern: /死|去世|葬/, image: "死亡意象", meaning: "在梦里往往象征结束与转化,而非字面含义——某个阶段可能正在落幕" },
  { pattern: /蛇/, image: "蛇", meaning: "既可能代表恐惧或压力源,也常被视为转化与生命力的象征" },
  { pattern: /房子|房间|家/, image: "房屋", meaning: "常被看作自我的映射;房间的明暗,或许对应你心里不同的角落" },
  { pattern: /迷路|找不到/, image: "迷路", meaning: "可能对应着现实中的方向感缺失,或面对选择的犹疑" },
];
...
export function generateLocalDreamReading(
  ...
  return {
    theme: matched.length > 0 ? `与「${matched[0].image}」有关的梦` : "一个来自潜意识的讯息",
    keyImages,
